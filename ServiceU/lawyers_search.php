  ...
  <form class="row" name ="form1" method="post" action="searchresults.php">
    ...
    <!--<div class="well well-lg">
      <div class="row text-center">
		...
		<div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Connecting Lawyers and Clients locally</h1>
        <div class="row">
        	<a href="mydashboard.php" class="btn btn-primary btn-lg" style="width: 100%">
                  <span class="h2">Start servicing now</span>
            </a>
      ...
      <center> <img src="img/lawyers1.jpg" alt="" class="img-responsive"></center></div>
...
<div class="container">
  <div class="row">
    <div class="col-sm-6">
      <div class="thumbnail"> <img src="img/lawyers2.jpg" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">

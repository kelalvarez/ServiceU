<!-- Upload Pin Modal -->
<div class="modal fade" id="editSkill" tabindex="-2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div id="interestEdited" style="margin-top:50px; width: 100%" class="mainbox col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info" >
                    <div class="panel-heading" style="background-color: #286090; text-align: center;">
                        <span class="modal-title" id="myModalLabel" style="color: #fff"><span class="glyphicon glyphicon-wrench"> </span> Edit Skill</span>
                        ...
                        <form id="editInterestform" class="form-horizontal" name="editDegree" action="profile.php?email=<?php echo $_SESSION['loginEmail']; ?>" method="POST">
                            <div class="form-group">
                                ...
                                <div style="text-align: center;">
                                  ...
                                  <button name="submitSkill" type="button" class="btn btn-default"><span id="addSkill" class="glyphicon glyphicon-plus" aria-hidden="true" style="color: #286090"></span></button>
                                </div>
                                
                                
                                <div style="text-align: center; margin-top: 30px;">
                                  <button name="submitSkill" type="submit" type="button" class="btn btn-primary"><i class="icon-hand-right"></i>Save</button>
                                </div>

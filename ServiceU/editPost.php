...
<div class="modal fade" id="editPost" tabindex="-2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div id="editP" style="margin-top:50px; width: 100%" class="mainbox col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info" >
                    ...
                    <div class="panel-body" >
                        <form id="changePasswordform" class="form-horizontal" action="postComplete.php?jobID=<?php echo $jobID ?>" name="editDegree" method="POST">
                                ...
                                <div class="form-group" style="color: #2e6da4">
                                    ...
                                    <div id="jobt" class="row" >
                                        ...
                                        <div class="col-md-4 col-lg-push-1">
                                                <input type="text" class="form-control" value="<?php echo $title;?>" name="jobTitle">
                                    ...
                                    <div id="jobd" class="row" >
                                        ...
                                        <div class="col-md-4 col-lg-push-1">
                                            <input type="text" value="<?php echo $description;?>" class="form-control" name="jobDescription">
                                        </div>
                                    </div>
                                    <br>
                                    <div id="jobp" class="row" >
                                        ...
                                        <div class="col-md-4 col-lg-push-1">
                                            <input type="text" class="form-control" value="<?php echo $payment;?>" name="jobPayment">
                                        </div>
                                    </div>

...
<html lang="en"> <!--Start HTML-->
    ...
    <!--BODY-->
    <body class="indexBody"> <!--Start Body-->
        ...
        <div class="container-fluid" id="mainCon"> <!--Start of full container-->
            ...
            <div class="carousel slide" id="myCarousel" data-ride="carousel"> <!--Start of background carousel-->
                ...
                <div class="carousel-inner"> <!--Inner -->
                        ...
                        <div class="item active">
                            <img src="img/bg2.jpg" alt="img1" class="img-responsive">

                        </div>

                        <div class="item">
                            <img src="img/bg4.jpg" alt="img2" class="img-responsive">
            ...
            <!--End Carousel Here-->
              ...
              <div class="container" id="loginContainer"> 
                ...
                <div class="welcome-section" id="OuterWelcomeContainer">

                        <h1><b>Welcome to ServiceU.</b></h1>
                    
                        <p>A service that connects local people in their community -- and to provide a secure and reliable environment who are looking

                            to provide or receive services.</p>
                </div>    
              ...
              <div class="OuterFooterContainer">
                                <ul class="list-inline">
                                  ...
                                  <li><h5 style="color: white">&#169 2015 ServiceU, Inc, All rights reserved.</h5></li>
                                </ul>

  ...
  <form class="row" name ="form1" method="post" action="searchresults.php">
    ...
    <!--<div class="well well-lg">
      <div class="row text-center">
		...
		<div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Renovating the Domain of Healthcare</h1>
        <div class="row">
        	<a href="mydashboard.php" class="btn btn-primary btn-lg" style="width: 100%">
                  <span class="h2">Start servicing now</span>
            </a>
      ...
      <p class="text-center">Online cloud based software stage with accessible and instant health care services.<br>
      </p>
      <center> <img src="img/doctors_serives1.jpg" alt="" class="img-responsive"></center></div>

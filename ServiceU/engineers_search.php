...
<span class="h1">ServiceU</span>
  <form class="row" name ="form1" method="post" action="searchresults.php">
    ...
    <!--<div class="well well-lg">
      <div class="row text-center">
		...
		<div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Brilliance and Revolution Assembled into All Design</h1>
        <div class="row">
        	<a href="mydashboard.php" class="btn btn-primary btn-lg" style="width: 100%">
                  <span class="h2">Start servicing now</span>
            </a>
      ...
      <p class="text-center">Online cloud based software stage with accessible and instant ingenuity services.<br>
      </p>
      <center> <img src="img/engineers.jpg" alt="" class="img-responsive"></center></div>
  ...
  <div class="row">
    <div class="text-center col-sm-6">
      ...
      <p>ServiceU is the best place to find experience engineers. </p>

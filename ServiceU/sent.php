                            ...
                            <div class="panel panel-default">
                              ...
                              <div class="panel-heading">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xs-6 col-md-2 myHeaderInbox">Receiver</div>
                                  <div class="col-xs-6 col-md-5 myHeaderInbox">My last message</div>
                                  ...
                                  <?php
                                    ...
                                    if(!empty($result)){
                                             ...
                                             while ($row = mysqli_fetch_assoc($result)){
                                              ...
                                              //sender info
                                              $senderEmail = $row['receiverEmail'];
                                              $senderID = getID($senderEmail);
                                        
                                              //msgStatus
                                               $msgStatus = getMessageStatusByID($row['dataID']);
                                                 
                                            if(($userEmail == $row['senderEmail']) && $msgStatus == 'Sent' && $msgStatus != 'Deleted'){  
    ...
    if(isset($_POST['submitToDeleteSent']))  
            { 
                ...
                if(isset($_POST['deleteAllSent'])){ 
                          ...
                          $status = "Deleted";
                          moveMessageToDelete($userEmail, $status);

...
<span class="h1">ServiceU</span>
  <form class="row" name ="form1" method="post" action="searchresults.php">
    ...
    <!--<div class="well well-lg">
      <div class="row text-center">
		...
		<div class="col-lg-12">
      <div class="jumbotron">
        <h1 class="text-center">Your Dream. Our Origination and Event solutions.</h1>
        <div class="row">
        	<a href="mydashboard.php" class="btn btn-primary btn-lg" style="width: 100%">
                  <span class="h2">Start servicing now</span>
            </a>
      ...
      <p class="text-center">Online cloud based software stage with accessible and instant event services.<br>
      </p>
      <center> <img src="img/event12.jpg" alt="" class="img-responsive" style="width:1200px;height:400px"></center></div>
  ...
  <div class="row">
    <div class="text-center col-sm-6">
      ...
      <p>ServiceU is the best place to find experience event organizers. </p>
...
<div class="container">
  <div class="row">
    <div class="col-sm-6">
      <div class="thumbnail"> <img src="img/event1.jpg" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">
          <h3>Find an Event Organizer</h3>
          <p>ServiceU provides experienced and best event organizers.</p>
          <hr>
        <p><a href="searchresult_event.php" class="btn btn-primary" role="button">Search for an organizer</a></p>
        </div>
      </div>
    </div>
    <div class="col-sm-6">
      <div class="thumbnail"> <img src="img/event2.jpg" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">
          <h3>Choose the Right Event Organizer</h3>
          <p>ServiceU is the perfect platform to find &nbsp;excellent and best event organizers.</p>
          <hr>
          <p><a href="searchresult_event.php" class="btn btn-primary" role="button">Search for an organizer</a></p>
        </div>
      </div>

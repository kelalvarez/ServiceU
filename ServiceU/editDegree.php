        ...
        <div class="row">
            ...
            <div class="col-md-9">        
                ...
                <div class="panel panel-info">
                    <div class="panel-heading" style="text-align: center"><h3><b><span class="glyphicon glyphicon-education"></span> Education</b></h3></div>
                        <div class="panel-body">


                                     <form action="" role="form" method="POST" class="form-horizontal" id="userEducationEdit">
                                         
                                          <div class="form-group">
                                                        <label for="userEDU" class="col-sm-5 control-label">School Name:</label>
                                                        <div class="col-sm-4">
                                                          <input type="userSkill" name="eduSchoolName" class="form-control" placeholder="Type school full name..." value="<?php 

                                                                        
                                                                              if(isset($_GET['eduID']))
                                                                                     {
                                                                                            $idEdu = $_GET['eduID'];
                                                                                            echo getUserSchoolName($idEdu);
                                                                                     }                                                       
                                            ...
                                            <div class="form-group">
                                                        <label for="userEDU" class="col-sm-5 control-label">Degree Level:</label>
                                                            <select name="eduDegreeLevel" style="margin-left: 15px; width: 240px; margin-top: 2px;" aria-labelledby="DegreeLevelLabel" id="DegreeLevel">
                                                            <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idEdu = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserDegreeLevel($idEdu) . '</option>';
                                                                                     }
                                                                                 ?>    
                                          ...
                                          <div class="form-group">
                                                        <label for="userEDU" class="col-sm-5 control-label">Field of Study:</label>
                                                        <div class="col-sm-4">
                                                          <input type="userDegree" name="eduDegreeName" class="form-control" placeholder="Comuputer Science... (if applicable)..." value="<?php 

                                                                        
                                                                              if(isset($_GET['eduID']))
                                                                                     {
                                                                                            $idEdu = $_GET['eduID'];
                                                                                            echo getUserDegreeName($idEdu);
                                                                                     }                                                       
                                            ...
                                            <div class="form-group">
                                                        <label for="userEDU" class="col-sm-5 control-label">Country:</label>
                                                        <select  name="eduCountry" style="margin-left: 15px; width: 240px; margin-top: 2px;" aria-labelledby="CountryIdLabel" id="CountryId">
                                                            
                                                            <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idEdu = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserEduCountry($idEdu) . '</option>';
                                                                                     }
                                                                                 else
                                                                                 {
...
<option value="Afghanistan" title="Afghanistan">Afghanistan</option>
	...
	<option value="Zimbabwe" title="Zimbabwe">Zimbabwe</option>
                                          ...
                                          <div class="form-group">
                                                        <label for="userEDU" class="col-sm-5 control-label">Location:</label>
                                                        <div class="col-sm-4">
                                                          <input type="userSkill" name="eduLocation" class="form-control" placeholder="City, State..." value="<?php 

                                                                        
                                                                              if(isset($_GET['eduID']))
                                                                                     {
                                                                                            $idEdu = $_GET['eduID'];
                                                                                            echo getUserEduLocation($idEdu);
                                                                                     }                                                       
                                            ...
                                            <div class="form-group">
                                                        ...
                                                        <select style="margin-left: 15px; margin-top: 2px;" aria-labelledby="StartMonthLabel" id="StartMonth" name="eduStartMonth">
                                                             <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idExp = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserEduStartMonth($idExp) . '</option>';
                                                                                     }
	...
	<option value="December">December</option>
                                                        ...
                                                        <select style="margin-left: 30px; margin-top: 2px;" aria-labelledby="StartYearLabel" id="StartYear" name="eduStartYear">
                                                            
                                                            <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idExp = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserEduStartYear($idExp) . '</option>';
                                                                                     }
                                                                                  ?>
    ...
    <option value="1926">1926</option>
                                                        ...
                                                        <select style="margin-left: 15px; margin-top: 10px;" aria-labelledby="StartMonthLabel" id="StartMonth" name="eduEndMonth">
                                                            <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idExp = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserEduEndMonth($idExp) . '</option>';
                                                                                     }
                                                                                  ?>
...
<option value="January">January</option>
	...
	<option value="December">December</option>
                                                        ...
                                                        <select style="margin-left: 30px; margin-top: 2px;"aria-labelledby="StartYearLabel" id="StartYear" name="eduEndYear">
                                                            <?php
                                                                                 if(isset($_GET['eduID']))
                                                                                  {
                                                                                            $idExp = $_GET['eduID'];
                                                                                            echo '<option selected="selected">' . getUserEduEndYear($idExp) . '</option>';
                                                                                     }
                                                                                  ?>
...
<option value="1926">1926</option>
                                         ...
                                         <div class="form-group" style="text-align:center; margin-top: 5%;">
                                                ...
                                                <div style="border-top-style: solid; border-width: 1px; border-top-color: #bce8f1; padding-top: 10px;">                                                  
                                                     <button type="submit" value="submit" name="submitEducation" class="btn btn-info">Update Change</button>
                                                </div>
    ...
    <script>
$('#userEducationEdit').ajaxForm(function() { 
 success : function(){
    ...
    <?php
            ...
            { 
                ...
                $user_educountry ="";
                $user_edulocation ="";
                $user_edustartDateMonth ="";
                $user_edustartDateYear ="";
                $user_eduendDateMonth ="";
                $user_eduendDateYear ="";
                

              if(empty($_POST['eduSchoolName'])) {
                //$emailErr = "Email is required";

              } else {
                $user_eduschoolName = test_user_input($_POST['eduSchoolName']);
              }

              if(empty($_POST['eduDegreeLevel'])) {
                //$firstnameErr = "First Name is required";

              } else {
                $user_edudegreeLevel = test_user_input($_POST['eduDegreeLevel']);
              }

              if(empty($_POST['eduDegreeName'])) {
                //$lastnameErr = "Last Name is required";
              } else {
                $user_edudegreeName = test_user_input($_POST['eduDegreeName']);
              }

              if(empty($_POST['eduCountry'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_educountry = test_user_input($_POST['eduCountry']);
              }
                                 
              if(empty($_POST['eduLocation'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_edulocation = test_user_input($_POST['eduLocation']);
              }
                                 
                                                           
              if(empty($_POST['eduStartMonth'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_edustartDateMonth = test_user_input($_POST['eduStartMonth']);
              }
                                 
              if(empty($_POST['eduStartYear'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_edustartDateYear = test_user_input($_POST['eduStartYear']);
              }
                                 
              if(empty($_POST['eduEndMonth'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_eduendDateMonth = test_user_input($_POST['eduEndMonth']);
              }
                                 
              if(empty($_POST['eduEndYear'])) {
                //$passwordnameErr = "Password is required";
              } else {
                $user_eduendDateYear = test_user_input($_POST['eduEndYear']);
              }
            
                
              if(!empty(isset($_GET['eduID']))){
                  
                        $tempID = $_GET['eduID'];
                  
                        updateUserEducation($tempID, $user_eduschoolName,  $user_edudegreeLevel,  $user_edudegreeName, $user_educountry, $user_edulocation,                                                     $user_edustartDateMonth, $user_edustartDateYear, $user_eduendDateMonth, $user_eduendDateYear);
                  

              }else{
             
                                 
                        insertUserEducation($userEmail, $user_eduschoolName,  $user_edudegreeLevel,  $user_edudegreeName, $user_educountry, $user_edulocation,                                                     $user_edustartDateMonth, $user_edustartDateYear, $user_eduendDateMonth, $user_eduendDateYear);

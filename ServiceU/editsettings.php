     ...
     <?php
            ...
            if(isset($_POST['updateUserAccount']))
            {
              ...
              if(empty($_POST['userAccountEmail'])) {
                ...
                $user_newEmail = test_user_input($_POST['userAccountEmail']);
              }

              if(empty($_POST['userCurrentPasswordEmail'])) {
                 $user_userPasswordERR = "Password is required!";

              } else {
                $user_userPassword = test_user_input($_POST['userCurrentPasswordEmail']);
              }
